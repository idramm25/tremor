...
void ADXL345::setImportantInterruptMapping(int data_ready, int single_tap, int double_tap, int free_fall, int activity, int inactivity) {  //<<<<-----data_ready ADDED
	//////////////////////////////////////////////////////////////////////////////////////////////////
	if(data_ready == 1) {										//		<<<<<-----ADDED
		 setInterruptMapping(	ADXL345_INT_DATA_READY_BIT, ADXL345_INT1_PIN );}		//
