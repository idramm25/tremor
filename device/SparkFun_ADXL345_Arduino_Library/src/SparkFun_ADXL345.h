...
public:
	...
	void setImportantInterruptMapping(int data_ready, int single_tap, int double_tap, int free_fall, int activity, int inactivity);    //<<<------------data_ready ADDED
	...
	void dataReadyINT(bool status);                              //<<<<<--------------ADDED 
